...
# ==============================================================================
"""Extends the celeba dataset by adding embedding from facenet.

TODO: add script to get the dataset and to run facenet on it.
"""
...
def get_split(split_name, dataset_dir, file_pattern=None, reader=None):
  ...
  keys_to_features = {
    ...
    'image/embedding': tf.FixedLenFeature(
        [DEFAULT_ENCODING_SIZE], tf.float32),
    'image/features/facial_features': tf.FixedLenFeature([136], tf.float32, ),  # From Dlib.
  }
  ...
  items_to_handlers = {
    ...
    'embedding':  slim.tfexample_decoder.Tensor('image/embedding'),
    'dlib_landmarks':  slim.tfexample_decoder.Tensor('image/features/facial_features'),
  }
  ...
  return slim.dataset.Dataset(
      ...
      items_used=[ 'source', 'filename', 'embedding', 'conditional_labels','landmarks', 'dlib_landmarks'],
      items_need_preprocessing=['source', 'conditional_labels',],
