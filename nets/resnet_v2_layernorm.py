...
def resnet_v2(inputs,
  ...
  with tf.variable_scope(scope, 'resnet_v2', [inputs], reuse=reuse) as sc:
    ...
    with slim.arg_scope([slim.conv2d, bottleneck,
      ...
      # Appendix of [2].
      net = slim.layer_norm(net, activation_fn=tf.nn.relu, scope='postnorm')
...
def resnet_v2_5(inputs,
  ...
  blocks = [
      ...
      resnet_v2_block('block2', base_depth=64, num_units=3, stride=2),
      resnet_v2_block('block3', base_depth=128, num_units=4, stride=2),
      resnet_v2_block('block4', base_depth=256, num_units=4, stride=1),
  ]
  return resnet_v2(inputs, blocks, num_classes, is_training=is_training,
                   global_pool=global_pool, output_stride=output_stride,
                   include_root_block=True, spatial_squeeze=spatial_squeeze,
                   reuse=reuse, scope=scope)
resnet_v2_5.default_image_size = resnet_v2.default_image_size
